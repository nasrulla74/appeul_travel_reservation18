...
class HotelRoomType(models.Model):
    ...
    room_type_name = fields.Char('Room Type Name', default='')
    description = fields.Text(string="Description")
    room_type_state = fields.Selection([('available', 'available'), ('reserve', 'Reserve')], default='available')
    hotel_id = fields.Many2one('hotel.hotel', string='Hotel', default=0)
    meal_id = fields.Many2one('hotel.meal', string="Meal Plan", default=0)
    room_category_id = fields.Many2one('room.category', string="Room Category", default=0)
...
class HotelAmenities(models.Model):
    ...
    name = fields.Char(string="Name")
    fa_icon = fields.Char('Fa-Icon', default="fa-thin fa-check")
    icon = fields.Image(string="SVG Icon")
    category_id = fields.Many2one('amenity.category', string='Category')
...
class GhMeals(models.Model):
    ...
    meal_code = fields.Char(string="Meal Code")
...
#     island_tag = fields.Char(string="Tag")
#     island_type = fields.Char(string="Island Type")
#     island_latitude = fields.Float('Island Latitude', digits=(10, 7))
#     island_longitude = fields.Float('Island Longitude', digits=(10, 7))
