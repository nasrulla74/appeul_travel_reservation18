...
class Hotel(models.Model):
    ...
    hotel_ref_id = fields.Char(string="Ref Id")
    ...
    tot_beds = fields.Integer(string="Total Beds", default=0)
    tot_rooms = fields.Integer(string="Total Rooms", default=0)
    misc_info = fields.Text(string="Misc Info")
    resort_phone = fields.Text(string="Resort Phone")
    resort_email = fields.Text(string="Resort Email")
    destination_group_id = fields.Many2one('destination.group', string="Destination Group")
